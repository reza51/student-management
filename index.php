...
<head>
	...
	<link rel="icon" type="image/png" href="./assets/img/smr.png">
    <meta charset="UTF-8">
            ...
            <div class="wrap-login100">
                <form method="post" action="" class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input">
                        ...
                        <span class="focus-input100" data-placeholder="Username / NIS" aria-required="HARUS DIISI"></span>
                    </div>
                    ...
                    <div class="wrap-input100 validate-input" data-validate="password">
                        ...
                        <span class="focus-input100" data-placeholder="Password" aria-required="HARUS DIISI"></span>
                    </div>
				...
				if ($_SERVER['REQUEST_METHOD']=='POST') {
					...
					if ($level==1) {
						...
						window.location.replace('./kesiswaan/');
						} ,3000);   
						</script>";					
						...
						swal('Mohon Maaf', 'Username / Password Salah', {
						icon : 'error',
						buttons: {        			
						confirm: {
						...
						// Siswa
								...
								window.location.replace('./');
									...
									// Siswa
									$sqlCek = mysqli_query($con,"SELECT * FROM tb_guru WHERE nip='$_POST[username]' AND password='$pass' AND status='P'");
									$jml = mysqli_num_rows($sqlCek);
									$d = mysqli_fetch_array($sqlCek);
									
									if ($jml > 0) {
									$_SESSION['pelatih']= $d['id_guru'];
									echo "
									<script type='text/javascript'>
									setTimeout(function () { 
									...
									window.setTimeout(function(){ 
									window.location.replace('./pelatih/');
									} ,3000);   
									</script>";					
