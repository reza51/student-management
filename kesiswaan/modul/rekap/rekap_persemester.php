...
INNER JOIN tb_semester ON _logabsensi.id_semester=tb_semester.id_semester
INNER JOIN tb_thajaran ON _logabsensi.id_thajaran=tb_thajaran.id_thajaran
WHERE tb_mengajar.id_mengajar='$_GET[pelajaran]' AND tb_mengajar.id_mkelas='$_GET[kelas]'  AND tb_thajaran.status=1 AND tb_semester.status=1
...
<table width="100%" border="1" cellpadding="2" style="border-collapse: collapse;">
  <tr>
    ...
    <td colspan="<?=$d['semester'] ?> |" style="padding: 8px;"><b>Semester :</b></td>
