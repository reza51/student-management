...
<head>
	...
	<title>Kesiswaan | Student Management</title>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.php" class="logo">
					...
					<b class="text-white">Student Management</b>
				</a>
						...
						<li class="nav-section">
							...
							<div class="collapse" id="rekapAbsen">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=rekap<?=$dm['id_presensi'] ?> ">
											<span class="sub-item"><!-- <?=strtoupper($dm['mapel']); ?> -->REKAP/BULAN </span>
										</a>
									</li>
								<?php } ?>
								</ul>
								...
								<ul class="nav nav-collapse">
									...
									foreach ($mengajar as $dm) { ?>
									<li>
										<a href="?page=rekap&act=rekap_sms<?=$dm['id_presensi'] ?> ">
											<span class="sub-item"><!-- <?=strtoupper($dm['mapel']); ?> -->REKAP/SEMESTER </span>
										</a>
									</li>
								<?php } ?>
								</ul>
		...
		<div class="main-panel">
			<div class="content">
				...
				if ($page=='absen') {
					...
					if ($act=='') {
						include 'modul/rekap/rekap_bulan.php';
					}elseif ($act=='rekap_sms') {
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Website Monitoring Ekstrakurikuler SMKN 1 JENANGAN (<a href="index.php">Reza Fp</a> | 2024)
					</div>				
				</div>
			</footer>
		</div>
