...
// jumlah guru
$jumlahGuru = mysqli_num_rows(mysqli_query($con,"SELECT * FROM tb_guru WHERE status='Y' & 'P' "));
...
<head>
	...
	<link rel="icon" href="../assets/img/smr.png" type="image/png"/>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					...
					<b class="text-white">SMKN 1 JENANGAN</b>
				</a>
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
								...
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=master&act=mapel">
											<span class="sub-item">Minatbakat</span>
										</a>
									</li>
						...
						<li class="nav-item">
							<a data-toggle="collapse" href="#pelatih">
							...
							<div class="collapse" id="pelatih">
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=pelatih&act=add ">
											<span class="sub-item"> Tambah Pelatih </span>
										</a>
									</li>
									<li>
										<a href="?page=pelatih">
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=guru&act=add ">
											<span class="sub-item"> Tambah Kesiswaan </span>
										</a>
									</li>
									<li>
										<a href="?page=guru">
											<span class="sub-item"> Daftar Kesiswaan </span>
										</a>
									</li>
								</ul>
							</div>
							...
							<a data-toggle="collapse" href="#absen">
							 ...
							 <div class="collapse" id="absen">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=absen&act=surat_view">
											<span class="sub-item"> Izin </span>
										</a> 
									</li>
									<li>
										<a href="?page=absen&act=konfirmasi">
											<span class="sub-item"> Konfirmasi Absen </span>
										</a> 
									</li>
									<li>
										<a href="?page=absen&act=update">
											<span class="sub-item"> Update Absen </span>
										</a> 
									</li>
								</ul>
							</div> 
						...
						<li class="nav-item">
							...
							<div class="collapse" id="jurnal">
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=jurnal&act=add ">
											<span class="sub-item"> Isi Jurnal </span>
										</a>
									</li>
									<li>
										<a href="?page=jurnal">
											<span class="sub-item"> Daftar Jurnal </span>
										</a>
									</li>
								</ul>
							</div>
		...
		<div class="main-panel">
			<div class="content">
				...
				// tahun ajaran
					...
					include 'modul/master/ta/data_ta.php'; 
					}elseif ($act=='delta') {
					...
					include 'modul/master/mapel/data_mapel.php'; 
					}elseif ($act=='delmapel') {
				...
				}elseif ($page=='kesiswaan') {
           if ($act=='') {
               include 'modul/kesiswaan/data.php'; 
           }elseif ($act=='add') {
                include 'modul/kesiswaan/add.php'; 
           }elseif ($act=='edit') {
               include 'modul/kesiswaan/edit.php'; 
           }elseif ($act=='del') {
                include 'modul/kesiswaan/del.php'; 
           }elseif ($act=='proses') {
                include 'modul/kesiswaaan/proses.php'; 
           }
        }elseif ($page=='pelatih') {
           if ($act=='') {
          ...
          if ($act=='') {
               include 'modul/jurnal/data.php'; 
           }elseif ($act=='add') {
                include 'modul/jurnal/add.php'; 
           }elseif ($act=='edit') {
               include 'modul/jurnal/edit.php'; 
           }elseif ($act=='del') {
                include 'modul/jurnal/del.php'; 
           }elseif ($act=='proses') {
                include 'modul/jurnal/proses.php'; 
           }   
        }elseif ($page=='rekap') {
					if ($act=='') {
			...
			if ($act=='') {
                ...
                include 'modul/jadwal/proses.php'; 
           } 					
		}elseif ($page=='') {
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Student Monitoring (<a href="index.php">Reza Fp </a> | 2024)
					</div>				
				</div>
			</footer>
		</div>
