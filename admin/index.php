			...
			<div class="wrap-login100">
				<form method="post" action="" class="login100-form validate-form">
					<span class="login100-form-title p-b-48">
						...
						<img src="../assets/img/smr.png" width="160">
					</span>
					...
					<div class="wrap-input100 validate-input">
						...
						<span class="focus-input100" data-placeholder="Username / NIS"></span>
					</div>
						...
						<div class="wrap-login100-form-btn">
							...
							<button type="submit" class="login100-form-btn">
								Login
									...
									$sqlCek = mysqli_query($con,"SELECT * FROM tb_admin WHERE username='$_POST[username]' AND password='$pass' AND status='Y'");
									...
									swal('(Pembimbing) ', 'Login berhasil', {
									icon : 'success',
									buttons: {        			
									confirm: {
