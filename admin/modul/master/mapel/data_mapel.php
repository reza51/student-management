    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                              <h4 id="exampleModalLabel" class="modal-title">Edit Minat/Bakat</h4>
            ...
            <div class="modal-body">
                <form action="" method="post" class="form-horizontal">
                     <div class="form-group">
                        ...
                        <input name="kode" type="text" value="MB-<?=time() ?>" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label>Nama Minat/Bakat</label>
                        <input name="mapel" type="text" placeholder="Nama Minat/Bakat .." class="form-control">
                    </div>
