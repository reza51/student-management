...
INNER JOIN tb_admin ON tb_admin.id_admin=tb_mengajar.id_admin
WHERE tb_mengajar.id_admin='$data[id_admin]' AND tb_mengajar.id_mengajar='$_GET[pelajaran]'  AND tb_thajaran.status=1  ");
...
<a href="#"><?=strtoupper($d['mapel']) ?></a>
					...
					<div class="row">
						...
						<label>
								...
								INNER JOIN tb_mengajar ON tb_izin.id_mengajar=tb_mengajar.id_mengajar
								AND tb_izin.id_mengajar='$_GET[pelajaran]' AND tb_mengajar.id_admin='$data[id_admin]'
