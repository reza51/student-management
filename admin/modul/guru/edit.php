...
$edit = mysqli_query($con,"SELECT * FROM tb_guru WHERE id_guru='$_GET[id]' AND status='Y'");
foreach ($edit as $d)?>
                ...
                <div class="col-lg-8">
                  <div class="card">
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Form Edit Kesiswaan</h3>
                    </div>
                    <div class="card-body">
						<form action="?page=guru&act=proses" method="post" enctype="multipart/form-data">
							<div class="form-group">
								...
								<input name="nip" type="text" pattern="[0-9]*" class="form-control" value="<?=$d['nip'] ?>" readonly>								
							</div>
