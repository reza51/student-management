						...
						<div class="col-md-8">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Form Tambah Jadwal Mengajar</div>
								</div>
								<div class="card-body">
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												<label for="kode">Kode Minat</label>
												<input name="kode" pattern="[0-9]*" type="text" class="form-control" id="kode" value="MB-<?=time();?>" readonly>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label>Pelatih Minat/Bakat</label>
