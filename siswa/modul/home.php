<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Website Student Management</h2>
						...
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-body">
										...
										<center>
											<img src="../assets/img/logojenpo.png" width="100">
											<br>
											<b>SMKN 1 JENANGAN</b>
										</center>
									</div>
									...
									<div class="tab-content mt-2 mb-3" id="pills-with-icon-tabContent">
										...
										<div class="tab-pane fade" id="pills-contact-icon" role="tabpanel" aria-labelledby="pills-contact-tab-icon">
											<p>
												...
												Website Monitoring Ekstrakurikuler Siswa ini dibuat untuk mendokumentasikan kehadiran dan kegiatan siswa.
											</p>
										</div>
									</div>
								</div>
